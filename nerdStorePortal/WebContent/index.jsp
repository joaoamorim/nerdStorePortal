...
<body>
	...
	<form action="processarPedido" method="post">
		...
		Quantidade:<input type="number" name="qdtRoboDomestico" value="1" min="0" size="2" width="20" ><br>

		2-<img src="images/medico.jpeg" width="50" height="50"
			alt="medico" /> Robo Médico -
		Quantidade:<input type="number" name="qdtRoboMedico" value="1" min="0" size="2" width="30"><br>
		
		3- <img src="images/seguranca.jpeg" width="50" height="50"
			alt="seguranca" />  Robo Segurança -
		Quantidade:<input type="number" name="qdtRoboSeguranca" value="1" min="0" size="2" width="50"><br>
		
		<hr>
		
		4- <img src="images/ReatorArc.png" width="50"
			height="50" alt="arc" /> Reator Ark -
		Quantidade:<input type="number" name="qdtReatorArk" value="1" min="0" size="2"><br>
		
		5- <img src="images/reatorSolar.jpeg" width="50"
			height="50" alt="arc" /> Reator Solar -
		Quantidade: <input type="number" name="qdtReatorSolar" value="1" min="0" size="2"> 
		<br><br>
		...
		<table>
			...
			<tr>
				...
				<td><input type="email" name="email" size="35" maxlength="100" value="teste@teste.com"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="cartao" size="30" value="4914824356781234"></td>
			</tr>
			<tr>
				<td class="tableColumnTitle">Vencimento do Cartão:</td>
				<td><input type="month" name="cartaoVenc" size="10" value="2017-09" ></td>
			</tr>
		</table>
